"""Index views (production memory track, stage 7: many views over one ledger).
...
The rule this stage exists to enforce: a corrupted index is not an incident,
...
thing to invalidate. Stage 8 fuses rankings from several
of these channels; this stage only builds them.
"""
...
def profile(records) -> dict:
    ...
    claim key (stage 5) is worth carrying: without it there is no key to
    project onto."""
    out = {}
