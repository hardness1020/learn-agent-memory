"""Hybrid retrieval (production memory track, section 8: Retrieve).
...
The channels themselves belong to section 7 (index.py). This module only
...
def retrieve(index, scope, query, k=TOP_K) -> list[tuple]:
    """The fused pipeline over section 7's views.
    ...
    and contradicting section 9's rule of injecting nothing rather than noise.
    """
