"""Temporal resolution (production memory track, section 5: Resolve).

Two questions this section answers, and one it refuses to answer destructively:
...
There is no UPDATE and no DELETE, here or in the ledger (section 2).
"""
...
class Operation:
    """What happened to one record, and why. Section 6 proposes these through a
...
def resolve(store, record, at=None) -> list:
    ...
    This is the write path section 4 hands into: the record is already typed and
